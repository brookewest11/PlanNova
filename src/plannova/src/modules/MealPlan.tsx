  ...
  return (
          ...
          <div className="grid-item">
            ...
            <div className="grid-container2">
                ...
                <div className="grid-item2">
                    <div className="mealbox"> wednesday 
                    <div>
                ...
                <div className="grid-item2">
                    <div className="mealbox"> thursday 
                    <div>
                ...
                <div className="grid-item2">
                    <div className="mealbox"> saturday 
                    <div>
