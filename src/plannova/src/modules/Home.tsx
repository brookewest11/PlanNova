...
function Home() {
  ...
  const handleDeleteClass = () => {
    if (selectedClassIndex !== "") {
      ...
      const updatedClasses = classes.filter((_, index) => index !== selectedIndex);
  ...
  return (
      ...
      {showAddClassPopup && (
        <div className="add-class-popup">
          <div className="add-class-popup-content">
            ...
            />
            <button className="add-class-sub-button" onClick={handleAddClass}>Add Class</button>
            <button className="add-class-cancel" onClick={() => setShowAddClassPopup(false)}>Cancel</button>
          </div>
        </div>
      )}
          ...
          <div className="delete-class-popup-content">
            ...
            {classes.map((note, index) => (
                <div
                  ...
                  style={{
                    backgroundColor: selectedClassIndex === index ? "#c7c7c7" : "#f0f0f0",
            ...
            <button className="delete-class-sub-button" onClick={handleDeleteClass}>Delete Class</button>
            <button className="delete-class-cancel" onClick={() => setShowDeleteClassPopup(false)}>Cancel</button>
          </div>
        </div>
      )}
    ...
    {showAddEvent && (
        <div className="add-event-popup">
          <div className="add-event-popup-content">
            ...
            />
            <button className='add-event-sub-button' onClick={handleAddEvent}>Add Event</button>
            <button className='add-event-cancel' onClick={() => setShowAddEvent(false)}>Cancel</button>
          </div>
        </div>
      )}
      ...
      {showAddNotePopup && (
        <div className="homepage-popup">
          <div className="homepage-popup-content">
            ...
            />
            <button className="add-note-sub-button" onClick={handleAddNote}>Add Note</button>
            <button className="homepage-cancel" onClick={() => setShowAddNotePopup(false)}>Cancel</button>
          </div>
        </div>
      )}
      ...
      {ShowDeleteNotePopup && (
        <div className="delete-note-popup">
          <div className="delete-note-popup-content">
            ...
            <div className="notes-container">
              {notes.map((note, index) => (
                <div
                  ...
                  style={{
                    backgroundColor: selectedNoteIndex === index ? "#c7c7c7" : "#f0f0f0",
            ...
            <button className="delete-note-sub-button" onClick={handleDeleteNote}>Delete Note</button>
            <button className="delete-note-cancel" onClick={() => setShowDeleteNotePopup(false)}>Cancel</button>
          </div>
        </div>
      )}
    ...
    <div className='top-grid'>
      ...
      <div className="notes-box">
            ...
            <button className="add-note-button" onClick={() => setShowAddNotePopup(true)}>+</button>
