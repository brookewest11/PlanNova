// Name: Fitness Tracker Search Bar
// Purpose / what code does: This component allows for the user to search for the type of workout they want to track.  
...
// Date revised: 4/21/2024
  // Major Revisions:
    // Date: 11/05/2023, Author: Kenadi Krueger
      // Modification: Fitness Search tsx and css files created. Search bar is implemented, compares input string with contents of workouts array. 
    // Date: 11/19/2023, Author: Kenadi Krueger
      // Modification: Added search bar and adding the elements into the textboxes 
    // Date: 02/12/2024, Author: Gabi Kruger
      // Modification: Front end theme updates
    //Date: 03/15/2024, Author: Gabi Kruger
      //Modification: Consistency with styling updates
// Preconditions: The user must be logged in and using the fitness tracker page. 
  // Acceptable inputs: Searching for a valid workout type. 
  // Unacceptable inputs: Non-valid workout types.
// Postconditions: Search bar utilized to type an input string and then select a workout
  // Return values: None explicitly returned. The component renders UI elements.
// Error and exception condition values: Input string length must be greater than 0, if no matches to workouts then display no results found. 
// Side Effects
  // State Updates: n/a
  // Network Requests: HTTP requests
// Invariants
  // UI Consistency (logo, navigation bar, buttons, etc.), this is a part of the overall fitness tracker page. 
